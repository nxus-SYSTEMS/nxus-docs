...
slug: v0.9.4/nxuskit/reference/providers/expert-systems
---
...
For writing custom rules, see the [Rule Authoring Guide](/v0.9.4/nxuskit/guides/clips-rule-authoring/).
