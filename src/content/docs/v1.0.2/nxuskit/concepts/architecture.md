...
slug: v1.0.2/nxuskit/concepts/architecture
---
...
See the [Provider Model](/v1.0.2/nxuskit/concepts/provider-model/) for the shared
...
Read the [C ABI Reference](/v1.0.2/nxuskit/reference/api-reference/) before embedding
...
- [Provider Model](/v1.0.2/nxuskit/concepts/provider-model/)
- [Streaming](/v1.0.2/nxuskit/guides/streaming/)
- [C ABI Reference](/v1.0.2/nxuskit/reference/api-reference/)
- [CLI Input Format Reference](/v1.0.2/nxuskit/reference/cli-reference/)
- [Examples](/v1.0.2/nxuskit/examples/)
