...
slug: v1.0.2/nxuskit/reference/providers/expert-systems
---
...
For writing custom rules, see the [Rule Authoring Guide](/v1.0.2/nxuskit/guides/clips-rule-authoring/).
