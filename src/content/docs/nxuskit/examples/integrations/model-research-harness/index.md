---
title: "Model Research Harness"
description: "Python-first harness for provider-neutral model research, Promptfoo import, CLIPS policy, Bayesian scoring, and dry-run lifecycle recommendations"
sidebar:
  hidden: true
---
...
The adjacent [Marimo workbench](https://github.com/nxus-SYSTEMS/nxusKit-examples/blob/main/examples/integrations/model-research-harness/marimo/README.md) provides a fixture-first
