...
description: Migrate from the legacy ClipsEnvironment API to the new
  ClipsSession API introduced in SDK v0.9.1.
slug: v0.9.2/nxuskit/migration/clips-session-migration
---
