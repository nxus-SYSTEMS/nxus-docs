...
slug: v0.9.2/nxuskit/reference/cli-reference
---
...
* `diffs`: structural differences (content\_length, word\_count, sentence\_count, elapsed\_ms, content\_similarity for 2-model comparisons)
