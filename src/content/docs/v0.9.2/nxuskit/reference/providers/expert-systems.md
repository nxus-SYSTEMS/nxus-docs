...
description: Configuration reference for the CLIPS rule engine, MCP, Mock, and
  Loopback providers.
slug: v0.9.2/nxuskit/reference/providers/expert-systems
---
...
For writing custom rules, see the [Rule Authoring Guide](/v0.9.2/nxuskit/guides/clips-rule-authoring/).
