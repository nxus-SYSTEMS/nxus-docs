...
slug: v1.0.5/nxuskit/getting-started/first-call
---
...
[Installation](/v1.0.5/nxuskit/getting-started/installation/) and
[Authentication](/v1.0.5/nxuskit/getting-started/authentication/).
...
Use the [C ABI Reference](/v1.0.5/nxuskit/reference/api-reference/) for function,
...
Use [Local LLM Providers](/v1.0.5/nxuskit/reference/providers/local-llms/) for model
...
| Goal | Read |
|------|------|
| Configure credentials | [Authentication](/v1.0.5/nxuskit/getting-started/authentication/) |
| Browse runnable projects | [Examples](/v1.0.5/nxuskit/examples/) |
| Stream responses | [Streaming](/v1.0.5/nxuskit/guides/streaming/) |
| Choose a provider | [Provider Model](/v1.0.5/nxuskit/concepts/provider-model/) |
| Use CLI JSON contracts | [CLI Input Format Reference](/v1.0.5/nxuskit/reference/cli-reference/) |
| Integrate through native boundaries | [C ABI Reference](/v1.0.5/nxuskit/reference/api-reference/) |
