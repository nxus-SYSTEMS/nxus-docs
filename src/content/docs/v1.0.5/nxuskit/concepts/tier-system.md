...
slug: v1.0.5/nxuskit/concepts/tier-system
---
...
| Python | `nxuskit` | `python -m pip install "nxuskit-py==1.0.5"` for pure-Python APIs; use a compatible SDK bundle for native/FFI features |
...
See the [License Activation Guide](/v1.0.5/nxuskit/concepts/licensing/) for the full workflow.
