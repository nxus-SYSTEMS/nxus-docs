...
slug: v1.0.1/nxuskit/reference/providers/expert-systems
---
...
For writing custom rules, see the [Rule Authoring Guide](/v1.0.1/nxuskit/guides/clips-rule-authoring/).
