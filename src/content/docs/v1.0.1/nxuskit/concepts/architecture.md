...
slug: v1.0.1/nxuskit/concepts/architecture
---
...
See the [Provider Model](/v1.0.1/nxuskit/concepts/provider-model/) for the shared
...
Read the [C ABI Reference](/v1.0.1/nxuskit/reference/api-reference/) before embedding
...
- [Installation](/v1.0.1/nxuskit/getting-started/installation/)
- [Provider Model](/v1.0.1/nxuskit/concepts/provider-model/)
- [Streaming](/v1.0.1/nxuskit/guides/streaming/)
- [C ABI Reference](/v1.0.1/nxuskit/reference/api-reference/)
- [CLI Input Format Reference](/v1.0.1/nxuskit/reference/cli-reference/)
- [Examples](/v1.0.1/nxuskit/examples/)
